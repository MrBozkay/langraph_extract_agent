...
class TestAboutExtractor:
    ...
    @patch("src.agents.about_extractor.AboutExtractor._call_langextract")
    def test_extract_from_markdown_text_success(self, mock_call):
        """Test successful extraction."""
        # Mock successful extraction
        mock_result = Mock()
        mock_result.owner_name = "Test Owner"
        mock_result.position = "CEO"
        mock_result.company_name = "Test Company"
        mock_result.email = "test@example.com"
        mock_result.phone = "+49 123 456789"
        mock_result.website = "www.example.com"
...
class TestAboutExtractorV2:
    ...
    @patch("src.agents.about_extractor_v2.AboutExtractorV2._call_langextract")
    def test_extract_from_markdown_text_success(self, mock_call):
