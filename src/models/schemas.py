...
class CompanyInfoLite(BaseModel):
    ...
    owner_name: str = Field(
        default="", description="Name of the business owner or primary contact person"
    )
    position: str = Field(
        default="",
    ...
    company_name: str = Field(
        default="", description="Official company name (e.g., Mustermann GmbH)"
    )
    email: str = Field(
        default="",
    ...
    fax: str = Field(default="", description="Fax number if available")
    ...
    sector: str = Field(
        default="", description="Business sector (e.g., Dentistry, Legal, Consulting)"
    )
